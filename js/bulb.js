...
var offBulbSVG = `<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="56" height="80" fill="none" viewBox="0 0 14 20">
...
var onBulbSVG = `<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="56" height="80" fill="currentColor" viewBox="0 0 15 20">
